...
class MastraBottomBar extends StatelessWidget {
  /// A bottom bar that faithfully follows the design by Aurélien Mastra
  ///
  /// https://dribbble.com/shots/5925052-Google-Bottom-Bar-Navigation-Pattern/
  const MastraBottomBar({
    super.key,
    required this.items,
  ...
  final List<MastraBottomBarItem> items;
                ...
                builder: (context, t, _) {
                  ...
                  return Material(
                    ...
                    child: InkWell(
                      ...
                      focusColor: bubbleColor ?? selectedColor.withOpacity(0.1),
                      highlightColor:
                          bubbleColor ?? selectedColor.withOpacity(0.1),
                      splashColor:
                          bubbleColor ?? selectedColor.withOpacity(0.1),
                      hoverColor: bubbleColor ?? selectedColor.withOpacity(0.1),
                      child: Padding(
                        padding: itemPadding -
...
/// A tab to display in a [MastraBottomBar]
class MastraBottomBarItem {
  /// An icon to display.
  final Widget icon;
